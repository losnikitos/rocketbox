...
Rails sends with `postmark_template_alias` values `password_reset`, `email_verification`, `subscribe_magic_link`, and `login_otp` (must match folder names under `postmark/`).
